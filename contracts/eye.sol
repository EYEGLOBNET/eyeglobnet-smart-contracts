...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        //emit OwnershipTransferred(owner, newOwner);  // TODO uncomment
        owner = newOwner;
    }
}
...
contract TempToken is ERC20, Ownable {
    ...
    function TempToken() public Ownable() {
        wallet = msg.sender;
        isICO = true;
    ...
    */
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        //emit Transfer(msg.sender, _to, _value);  // TODO uncomment
        return result;
    }
    ...
    */
    function transferICO(address _to, uint256 _value) public onlyOwner returns (bool) {
        ...
        //emit Transfer(wallet, _to, _value);  // TODO uncomment
        return true;
    }
    ...
    */
    ...
    function transferFrom(address _from, address _to, uint256 _value) public allowTransfer(_from) returns (bool) {
        ...
        if (result) {
            ...
            //emit Transfer(_from, _to, _value);  // TODO uncomment
        }
        return result;
    }
    ...
    function approve(address _spender, uint256 _value) public returns (bool) {
        ...
        //emit Approval(msg.sender, _spender, _value);  // TODO uncomment
        return true;
    }
    ...
    function increaseApproval(address _spender, uint _addedValue) public returns (bool) {
        ...
        //emit Approval(msg.sender, _spender, allowed[msg.sender][_spender]);  // TODO uncomment
        return true;
    }
...
contract CrowdSale is Ownable {
    ...
    uint internal presale_start = 1531774800; // 2018-07-17
    uint internal presale_end = 1533589200; // 2018-08-07
    uint internal ico_start = 1537218000; // 2018-09-18
    ...
    function start(address _token, uint256 _rate) public onlyOwnerOrManager {
        ...
        token = TempToken(_token);
        base_wallet = token.wallet();
        dec_mul = 10 ** uint256(token.decimals());

        // Organizasional expenses
        // address org_exp = 0xB88Cc9948F7227b626dCbFcc32Cbc0F9DA53167C;
        address org_exp = 0x1CAC60d851A44305D7Dd6ECf8fF32F3403427D3D;
        // Early birds
        // address ear_brd = 0xB88Cc9948F7227b626dCbFcc32Cbc0F9DA53167C;
        address ear_brd = 0x6aE0A9A6dFeD7B6Cf911cc9EA506635366F8EF04;
        // Community development
        // address com_dev = 0xB88Cc9948F7227b626dCbFcc32Cbc0F9DA53167C;
        address com_dev = 0x2b36a551A1d410cA77Ce3F1eab4272ba2fA3dFb3;
        // Special coins
        // address special = 0xB88Cc9948F7227b626dCbFcc32Cbc0F9DA53167C;
        address special = 0xb5e5992D2dA0bF779f1d46f29fAE37f04a0D96CA;
        // Team lock
        // vest_1 = 0x9f3418911E2a12817726d821d376395D5FE5F8a7;
        // vest_2 = 0xDd6D206a54D607f102c9790cb4D91452c6B3B041;
        // vest_3 = 0xf3da103DA921B57F076dCB7C24D951fb41Ee76a6;
        // vest_4 = 0x63dCAE803a9E96221C6b41AC8f57D23d0560473B;
        vest_1 = 0x851F9ed4D0fB836C6A782ed17246A257be131aa6;
        vest_2 = 0xBb9a8a2D34FA2f8DeB34C51AE84Dbda2707B1dCF;
        vest_3 = 0xA89A6cC952cbff62c6DaF2413898715031155835;
        vest_4 = 0x39Be98dc7aFD7dfA2134244741B13321E33CC581;
